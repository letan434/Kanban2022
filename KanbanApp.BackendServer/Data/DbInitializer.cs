    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (!_roleManager.Roles.Any())
            {
                ...
                //await _roleManager.CreateAsync(new IdentityRole
                //{
                //    Id = UserViewerRoleName,
                //    Name = UserViewerRoleName,
                //    NormalizedName = UserViewerRoleName.ToUpper(),
                //});
            }
            ...
            if (!_context.Functions.Any())
            {
                _context.Functions.AddRange(new List<Function>
                {
                    ...
                    new Function {Id = "CONTENT_PROJECT",Name = "Dự án",ParentId = "CONTENT",SortOrder = 2,Url = "/contents/projects",Icon="fa-edit" },
                    new Function {Id = "CONTENT_ISSUE",Name = "Nhiệm vụ",ParentId = "CONTENT",SortOrder = 3,Url = "/contents/issues",Icon="fa-edit" },
                    ...
                    new Function {Id = "STATISTIC_MONTHLY_NEWPJ",Name = "Dự án hàng tháng",ParentId = "STATISTIC",SortOrder = 2,Url = "/statistics/monthly-newkbs",Icon="fa-wrench"},
